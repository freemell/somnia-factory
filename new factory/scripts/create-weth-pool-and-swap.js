...
async function main() {
    console.log("Creating WETH pool and swapping 20 STT for WETH...");
    ...
    // First, get some WETH (if we don't have enough)
    if (initialWETHBalance < ethers.parseEther("10")) {
        console.log("Getting WETH from faucet or existing pools...");
    ...
    await weth.approve(poolAddress, liquidityAmount);
    ...
    const minAmountOut = ethers.parseEther("0.1"); // Minimum 0.1 WETH out
