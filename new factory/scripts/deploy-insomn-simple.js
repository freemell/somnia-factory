...
async function main() {
    console.log("🚀 Simple INSOMN Token Deployment and Swap Test...");
    ...
    // Manually add liquidity by transferring tokens directly
    console.log("\n=== Adding Liquidity to INSOMN/WETH Pool ===");
    
    // Transfer INSOMN tokens directly to the pool
    ...
    console.log("✅ Transferred 100,000 INSOMN tokens to pool");
    ...
    // Update pool liquidity manually
    await pool.addLiquidity(insomnLiquidity);
    console.log("✅ Updated pool liquidity");
